...
class Google {
	...
	public static function getPlaceDetails($place_id, $lang = 'en') {
		$content = @file_get_contents('https://maps.googleapis.com/maps/api/place/details/json?placeid='.$place_id.'&language='.$lang.'&key='.Google::$GOOGLE_SERVER_KEY);
		if ($content != false) {
